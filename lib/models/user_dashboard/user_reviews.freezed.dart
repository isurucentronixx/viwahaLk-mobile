...
class _$_UserReviews implements _UserReviews {
  ...
  @override
  String toString() {
    return 'UserReviews(id: $id, datetime: $datetime, listing_id: $listing_id, reply_id: $reply_id, user_id: $user_id, message: $message, image: $image, rating: $rating, firstname: $firstname, lastname: $lastname)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, datetime, listing_id,
      reply_id, user_id, message, image, rating, firstname, lastname);
