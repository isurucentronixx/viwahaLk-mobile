...
class _$UserNotificationImpl implements _UserNotification {
  ...
  @override
  String toString() {
    return 'UserNotification(id: $id, datetime: $datetime, user_type: $user_type, user_id: $user_id, listing_id: $listing_id, type: $type, detail: $detail, checked: $checked, hide: $hide)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, datetime, user_type, user_id,
      listing_id, type, detail, checked, hide);
