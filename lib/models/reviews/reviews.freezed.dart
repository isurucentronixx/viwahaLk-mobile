...
mixin _$Reviews {
  ...
  String? get user_image => throw _privateConstructorUsedError;
...
class _$ReviewsImpl implements _Reviews {
  ...
  @override
  String toString() {
    return 'Reviews(id: $id, datetime: $datetime, listing_id: $listing_id, reply_id: $reply_id, user_id: $user_id, message: $message, image: $image, rating: $rating, firstname: $firstname, lastname: $lastname, user_image: $user_image)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.user_image, user_image) ||
...
abstract class _Reviews implements Reviews {
  const factory _Reviews(
      ...
      final String? firstname,
      final String? lastname,
      final String? user_image}) = _$ReviewsImpl;
