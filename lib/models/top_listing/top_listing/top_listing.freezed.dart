...
TopListing _$TopListingFromJson(Map<String, dynamic> json) {
  return _TopListing.fromJson(json);
}
...
mixin _$TopListing {
  ...
  @JsonKey(ignore: true)
  $TopListingCopyWith<TopListing> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TopListingCopyWith<$Res> {
  factory $TopListingCopyWith(
          TopListing value, $Res Function(TopListing) then) =
      _$TopListingCopyWithImpl<$Res, TopListing>;
  @useResult
  $Res call(
      {String? id,
      String? datetime,
...
/// @nodoc
class _$TopListingCopyWithImpl<$Res, $Val extends TopListing>
    implements $TopListingCopyWith<$Res> {
  _$TopListingCopyWithImpl(this._value, this._then);
...
abstract class _TopListing implements TopListing {
  const factory _TopListing(
      {final String? id,
      final String? datetime,
      final String? user_id,
      final String? title,
      ...
      final String? personality,
      final String? next_step,
      final String? average_rating}) = _$_TopListing;
